...
class ChatrightItem extends StatelessWidget {
  const ChatrightItem({super.key, required this.item});
  final Msgcontent item;
  @override
  Widget build(BuildContext context) {
    return Container(
      padding:
          EdgeInsets.only(top: 10.w, right: 15.w, left: 15.w, bottom: 10.w),
      child: Row(
          ...
          ConstrainedBox(
            ...
            child: Container(
              ...
              padding: EdgeInsets.only(
                  top: 10.w, right: 10.w, left: 10.w, bottom: 10.w),
              decoration: BoxDecoration(
                  ...
                  borderRadius:
                      BorderRadiusDirectional.all(Radius.circular(10.w))),
